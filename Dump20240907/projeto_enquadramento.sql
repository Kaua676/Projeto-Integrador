...
--
-- Table structure for table `enquadramento`
--
...
--
-- Dumping data for table `enquadramento`
--

LOCK TABLES `enquadramento` WRITE;
/*!40000 ALTER TABLE `enquadramento` DISABLE KEYS */;
/*!40000 ALTER TABLE `enquadramento` ENABLE KEYS */;
UNLOCK TABLES;
